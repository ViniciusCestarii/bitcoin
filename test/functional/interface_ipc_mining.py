    ...
    def run_tx_collection_test(self):
        ...
        async def async_routine():
            ...
            async with AsyncExitStack() as stack:
                ...
                self.log.debug("Externally generated templates have no coinbase, fee, sigop, or waitNext accessors")
                for method_name in ("getCoinbaseTx", "getTxFees", "getTxSigops", "waitNext"):
                    assert not hasattr(template, method_name), f"external template unexpectedly exposes {method_name}"
